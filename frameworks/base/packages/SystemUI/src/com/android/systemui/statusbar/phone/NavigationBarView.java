...
public class NavigationBarView extends LinearLayout {
	...
	public View getReadingLightDownButton() {
		return mCurrentView.findViewById(R.id.reading_light_down);
	}

	public View getReadingLightUpButton() {
		return mCurrentView.findViewById(R.id.reading_light_up);
	}

	// [ADD]
	public View getStandByButton() {
		return mCurrentView.findViewById(R.id.standby);
	}
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
       ...
       //  getScreenshotButton().setVisibility(disableHome       ? View.INVISIBLE : View.VISIBLE);      
		...
		if((mContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT)
				&& ((mContext.getResources().getConfiguration().screenHeightDp < 720)
					|| (mContext.getResources().getConfiguration().screenWidthDp < 720))) {
        ...
        setVisibleOrGone(getSearchLight(), false);
        setVisibleOrGone(getCameraButton(), false);
